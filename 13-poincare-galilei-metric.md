...
$$
e^1 \;=\; R\, \sin\theta\, d\phi, \qquad
e^2 \;=\; R\, d\theta,
$$

after restoring the scale $R^2 = \lambda$. This is the orthonormal
coframe stated earlier — *derived* now, not asserted.
...
*Step 5: The metric.* By construction, $\{e^1, e^2\}$ is an orthonormal
coframe in which the algebra-derived metric is $\delta_{ab}$. Hence

$$
g = \delta_{ab}\, e^a \otimes e^b = (e^1)^2 + (e^2)^2,
$$

which evaluates in coordinates to
